...
class CicloEmeMedicaoutController extends Controller
{
    ...
    public function store(Request $request, Ciclo $ciclosos)
    {
        ...
        $ciclosos->fecha             = $hoy;
        $ciclosos->EmeMedicaout      = $hora;
        $ciclosos->salida            = $hora;
        $ciclosos->llave             = $llave;
        $ciclosos->total             = $total;
     ...
     *
     * @param  \App\CicloEmeMedicaout  $cicloEmeMedicaout
     * @return \Illuminate\Http\Response
     */
    public function show(CicloEmeMedicaout $cicloEmeMedicaout)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(CicloEmeMedicaout $cicloEmeMedicaout)
    {
        //
    }
}
