...
class CiclobanoController extends Controller
{
     ...
     *
     * @param  \App\Ciclobano  $ciclobano
     * @return \Illuminate\Http\Response
     */
    public function show(Ciclobano $ciclobano)
    {
        //
    }
    ...
    public function update(Request $request,  $id)
    {
        ...
        $datosdano = request()->except(['_token','_method']);
        Ciclo::where('id','=',$id)->update($datosdano);
  //return response()->json($ciclosos);
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Ciclobano $ciclobano)
    {
        //
    }
}
