...
e{
    ...
    margin-left: 5em;
            ...
            <h1 style="font-weight: bold; text-aline:center;">EMERGENCIA MEDICAS</h1>
        ...
        <div class="row">
            <div class="col-sm-4 style_card">
                <div class="card-space style_card">
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <p class="card-text reloj-text"><small class="text-muted2"><b>Fin:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><e class="tiemp-text">{{ old('salida', $ciclosos->salida)}}</e> </small></p>
                ...
                <div class="card-space style_card">
                    ...
                    <p class="card-text reloj-text"><small class="text-muted2"><b>Fin:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><e class="tiemp-text"> {{ old('almuerzoout', $ciclosos->almuerzoout)}} </e></small></p>
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <p class="card-text reloj-text"><small class="text-muted2"><b>Inicio:</b><e class="tiemp-text"> {{ old('capacitacion', $ciclosos->capacitacion)}} </e></small></p>
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Fin:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><e class="tiemp-text">{{ old('capout', $ciclosos->capout)}}</e> </small></p>
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Fin:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><e class="tiemp-text">{{ old('pausasout', $ciclosos->pausasout)}}</e> </small></p>
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Fin:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><e class="tiemp-text">{{ old('dañoout', $ciclosos->dañoout)}}</e> </small></p>
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <p class="card-text reloj-text"><small class="text-muted2"><b>Inicio:</b><e class="tiemp-text"> {{ old('evaluacion', $ciclosos->evaluacion)}} </e></small></p>
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Fin:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><e class="tiemp-text">{{ old('evaluacionout', $ciclosos->evaluacionout)}}</e> </small></p>
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Fin:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><e class="tiemp-text">{{ old('retroout', $ciclosos->retroout)}}</e> </small></p>
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Fin:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><e class="tiemp-text">{{ old('reunionout', $ciclosos->reunionout)}}</e> </small></p>
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Fin:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><e class="tiemp-text">{{ old('banoout', $ciclosos->banoout)}}</e> </small></p>
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Fin:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><e class="tiemp-text">{{ old('calamidadout', $ciclosos->calamidadout)}}</e> </small></p>
                ...
                <div class="card-space style_card">
                    <div class="card-bodyNew style_card">
                        ...
                        <div class="row">
                            ...
                            <form action="{{url('/cicloEmeMedicaout/'.$ciclosos->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    {{csrf_field()}}
                                    @method('PATCH')
                                   ...
                                   <div><input type="hidden" id= "nombre" name="nombre" value=" {{$user_nombre}}"></div>
                                    ...
                                    <div><input type="hidden" id= "EmeMedicaout" name="EmeMedicaout" value=" {{$hora}}"></div>
                                    <div><input type="hidden" name="salida" id="salida" value="{{ $hora }}"></div>
                                    <input type="hidden" name="total" id="total" value="{{$total}}">
                                    <input type="hidden" id="timeEmeMedica" name="timeEmeMedica" value="{{ $timeEmeMedica}}">
                                    <p class="card-text"><small class="text-muted2"><b>Inicio:</b><e class="tiemp-text"> {{ old('EmeMedica', $ciclosos->EmeMedica)}} </e></small></p>
                                <input type='submit' class="botones prueba-btn" value='Fin'>
                            </form>
                            </div>
                        </div>
                    </div>
...
<script src="{{asset('js/app.js')}}"></script>
      ...
      Swal.fire(
        'ALIVIATE PRONTO',
        'EL FIN DEL TURNO POR ENFERMEDAD QUEDARA REGISTRADO AL DAR CLIK EN EL BOTON FIN',
        'success'
      )
      </script>
      @stop
