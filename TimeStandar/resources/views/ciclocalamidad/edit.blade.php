                ...
                <div class="card-space style_card">
                    <div class="card-bodyNew style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                            <form action="{{url('/ciclocalamidad/'.$ciclosos->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    {{csrf_field()}}
                                    @method('PATCH')
                                   ...
                                   <div><input type="hidden" id= "nombre" name="nombre" value=" {{$user_nombre}}"></div>
                                    ...
                                    <div><input type="hidden" id= "calamidad" name="calamidad" value=" {{$hora}}"></div>
