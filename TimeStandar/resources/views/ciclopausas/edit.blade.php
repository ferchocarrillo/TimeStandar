...
e{
    ...
    margin-left: 5em;
            ...
            <h1 style="font-weight: bold; text-aline:center;">PAUSAS ACTIVAS</h1>
            ...
            <div class="col-sm-4 style_card">
                ...
                <div class="card-space style_card">
                    <div class="card-bodyNew1 style_card">
                        ...
                        <p class="card-text reloj-text"><small class="text-muted2"><b>Horas de Break </b> {{ old('timebreak', $ciclosos->timebreak)}} </small></p>
                      </div>
                    </div>
                    </div>
                    </div>
                ...
                <div class="card-space style_card">
                    <div class="card-bodyNew1 style_card">
                        ...
                        <p class="card-text reloj-text"><small class="text-muted2"><b>Horas de Almuerzo</b>  {{ old('timelunch', $ciclosos->timelunch)}}</small></p>
                      </div>
                    </div>
                    </div>
                    </div>
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="card-text reloj-text"><small class="text-muted2"  style="color:rgb(0, 0, 0)"><b>Horas de Capacitacion: </b><rem  class="tiemp-text">0</rem> </small></p>
                ...
                <div class="card-space style_card">
                    <div class="card-bodyNew style_card">
                        ...
                        <div class="row">
                            ...
                            <form action="{{url('/ciclopausas/'.$ciclosos->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                {{csrf_field()}}
                                @method('PATCH')
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Horas Daño de Equipo: </b><rem class="tiemp-text"> 0 </rem> </small></p>
                                @else
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Horas Daño de Equipo: </b><rem class="tiemp-text">  {{ $timedaño }}</rem> </small></p>
                                @endif
                        </div>
                    </div>
                    </div>
