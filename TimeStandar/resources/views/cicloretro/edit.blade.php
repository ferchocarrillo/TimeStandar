                ...
                <div class="card-space style_card">
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Inicio:</b><e> {{ old('EmeMedica', $ciclosos->EmeMedica)}} </e></small></p>
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Fin:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><e>{{ old('EmeMedicaout', $ciclosos->EmeMedicaout)}}</e> </small></p>
