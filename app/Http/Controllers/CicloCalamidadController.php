...
class CiclocalamidadController extends Controller
{
     ...
     *
     * @param  \App\cicloCalamidad  $cilocalamidad
     * @return \Illuminate\Http\Response
     */
    public function show(cicloCalamidad $ciclocalamidad)
    {
        //
    }
     ...
     *
     * @param  \App\Calamidad  $ciclocalamidad
     * @return \Illuminate\Http\Response
     */
    ...
    public function update(Request $request, $id)
    {
        ...
        $datoscalamidad = request()->except(['_token','_method']);
        Ciclo::where('id','=',$id)->update($datoscalamidad);
  //return response()->json($ciclosos);
     ...
     *
     * @param  \App\CicloCalamidad  $Ciclocalamidad
     * @return \Illuminate\Http\Response
     */
    public function destroy(CicloCalamidad $Ciclocalamidad)
    {
        //
    }
}
