        ...
        <div class="row">
            <div class="col-sm-4 style_card ">
                <div class="card-space style_card">
                    ...
                    <p class="card-text reloj-text"><small class="text-muted2"><b class="tiemp-text">Conexión: </b>  {{ old('total', $ciclosos->total)}}</small></p>
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Tiempo:</b>  {{ old('timecap', $ciclosos->timecap)}} <b>minutos</b></small></p>
                        </div>
                        </div>
                     </div>
                     </div>
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Tiempo:</b>  {{ old('timepausas', $ciclosos->timepausas)}} <b>minutos</b></small></p>
                ...
                <div class="card-space style_card">
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Ingreso:</b><e class="tiemp-text"> {{ old('EmeMedica', $ciclosos->EmeMedica)}} </e></small></p>
