...
e{
    ...
    margin-left: 5em;
            ...
            <h1 style="font-weight: bold; text-aline:center;">EVALUACIÓN</h1>
        ...
        <div class="row">
            <div class="col-sm-4 style_card">
                <div class="card-space style_card">
                  ...
                  <div class="col-sm-4 style_card style_card">
                <div class="card-space style_card">
                    <div class="card-bodyNew1 style_card">
                        <strong>
                ...
                <div class="card-space style_card">
                    <div class="card-bodyNew1 style_card">
                        ...
                        <p class="card-text reloj-text"><small class="text-muted2"><b class="tiemp-text">Tiempo:</b>  {{ old('timelunch', $ciclosos->timelunch)}} <b>minutos</b></small></p>
                      </div>
                    </div>
                    </div>
                    </div>
                ...
                <div class="card-space style_card">
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                            <form action="{{url('/ciclobano/'.$ciclosos->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    {{csrf_field()}}
                                    @method('PATCH')
                                   ...
                                   <div><input type="hidden" id= "nombre" name="nombre" value=" {{$user_nombre}}"></div>
                                    ...
                                    <div><input type="hidden" id= "bano" name="bano" value=" {{$hora}}"></div>
...
<script src="{{asset('js/app.js')}}"></script>
      ...
      <script>
      Swal.fire(
        'NO OLVIDES LAVARTE LAS MANOS ANTES DE REGRESAR',
        'REGISTRA TU VISITA AL BAÑO',
        'success'
      )
      </script>
      @stop
