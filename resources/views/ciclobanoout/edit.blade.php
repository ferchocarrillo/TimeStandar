...
e{
    ...
    margin-left: 5em;
            ...
            <h1 style="font-weight: bold; text-aline:center;">ESTAS REGISTRANDO TIEMPO EN EL BAÑO</h1>
                    ...
                    <div class="card-bodyNew1 style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Tiempo:</b>  {{ old('timereunion', $ciclosos->timereunion)}} </small></p>
                            </div>
                        </div>
                    </div>
                  </div>
                ...
                <div class="card-space style_card">
                    <div class="card-bodyNew style_card">
                        ...
                        <div class="row">
                            ...
                            <form action="{{url('/ciclobanoout/'.$ciclosos->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    {{csrf_field()}}
                                    @method('PATCH')
                                   ...
                                   <div><input type="hidden" id= "nombre" name="nombre" value=" {{$user_nombre}}"></div>
                                    ...
                                    <div><input type="hidden" id= "banoout" name="banoout" value=" {{$hora}}"></div>
                                    <input type="hidden" id="timebano" name="timebano" value="{{ $timebano}}">

                                    <p class="card-text reloj-text"><small class="text-muted2">Inicio:<e class="tiemp-text"> {{ old('bano', $ciclosos->bano)}} </e></small></p>
