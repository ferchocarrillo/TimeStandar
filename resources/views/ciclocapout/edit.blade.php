...
<div class="pull-right">
    <div class="col-md-12">
        ...
        e{
            ...
            <h1 style="font-weight: bold; text-aline:center;">ESTAS EN CAPACITACION</h1>
        </center>
        <div class="row">
            ...
            <div class="col-sm-4 style_card">
                ...
                <div class="card-space style_card">
                    <div class="card-bodyNew1 style_card">
                      ...
                      <p class="card-text reloj-text"><small class="text-muted2"><b>Tiempo:</b> {{ old('timelunch', $ciclosos->timebreak)}} <b> minutos</b></small></p>
                    </div>
                  </div>
                  </div>
                  </div>
                ...
                <div class="card-space style_card">
                    <div class="card-bodyNew style_card">
                     ...
                     <div><input type="hidden" id= "nombre" name="nombre" value=" {{$user_nombre}}"></div>
                      ...
                      <input type="hidden" id="timecap" name="timecap" value="{{ $timecapa }}">
...
<script src="{{asset('js/app.js')}}"></script>
      ...
      <script>
      Swal.fire(
        'TERMINAR CAPACITACION',
        'Al dar click en el botón FIN el tiempo de capacitacián terminará',
        'success'
      )
      </script>
      @stop
